...
TEST(value_test, add_ints) {
    core::value a(int64_t{ 10 });
    core::value b(int64_t{ 20 });
    auto result = a.add(b);
...
TEST(value_test, eq_ints) {
    core::value a(int64_t{ 42 });
    core::value b(int64_t{ 42 });
    core::value c(int64_t{ 0 });
